...
neurons_e = nest.Create('aeif_cond_exp', NE)
neurons_i = nest.Create('aeif_cond_exp', NI)
...
pl.savefig(project_path+'statesAdEx.png')
...
pl.savefig(project_path+'fitAdEx.png')
...
pl.savefig(project_path+'capacityAdEx.png')
